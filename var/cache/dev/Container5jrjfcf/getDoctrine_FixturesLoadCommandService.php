...
include_once $this->targetDirs[3].'/src/AppBundle/DataFixtures/ORM/LoadEstablishments.php';
include_once $this->targetDirs[3].'/src/AppBundle/DataFixtures/ORM/LoadProducts.php';
...
$a->addFixtures(array(0 => new \AppBundle\DataFixtures\ORM\LoadEstablishments(), 1 => new \AppBundle\DataFixtures\ORM\LoadProducts()));
