 ...
 */
class Establishment extends \AppBundle\Entity\Establishment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Establishment' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Establishment' . "\0" . 'designation', '' . "\0" . 'AppBundle\\Entity\\Establishment' . "\0" . 'products'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Establishment $proxy) {
